...
class TasksProvider(Task):
    ...
    def run(self, data):
        ...
        self.PLUGIN_PROVIDER = PluginProvider.PluginProvider()
        ...
        for plugin in plugins:
            plugin.set_verbose(self.PLUGIN_VERBOSE)
    ...
    def get_available_tasks(self):
        self.TASK_PROVIDER = TasksProvider.TasksProvider()
        self.TASK_PROVIDER.init_tasks_system(self.TASKS_CFG)
